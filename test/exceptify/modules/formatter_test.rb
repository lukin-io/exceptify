...
class FormatterTest < ActiveSupport::TestCase
  ...
  test "title returns correct content" do
    formatter = Exceptify::Formatter.new(@exception)
  ...
  test "subtitle with accumulated error" do
    formatter = Exceptify::Formatter.new(@exception, accumulated_errors_count: 3)
  ...
  test "subtitle with controller" do
    ...
    formatter = Exceptify::Formatter.new(@exception, env: env)
  ...
  test "app_name can be overwritten using options" do
    formatter = Exceptify::Formatter.new(@exception, app_name: "test")
