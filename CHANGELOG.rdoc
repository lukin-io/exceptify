...
* Require Rails 8.0.2 or newer for development and verification.
* Rename the Rails install generator command to <tt>exceptify:install</tt>.
* Rename the gem, require paths, namespace, templates, and documentation to <tt>exceptify</tt>.
...
* enhancements
  ...
  * Exceptify.notify_exception receives block & pass it to each notifier (by @pocke)
...
* enhancements
  ...
  * Turn Exceptify Rails agnostic (by @jweslley)
